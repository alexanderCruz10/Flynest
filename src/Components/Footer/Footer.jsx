                ...
                <div className="row gy-4">
                    ...
                    <div className="col-lg-3 col-md-6">
                        ...
                        <ul className="list-unstyled">
                            ...
                            <li><a href="#" className="footer-link"><i className="ri-information-line"></i> About Us</a></li>
                            <li><a href="#" className="footer-link"><i className="ri-phone-line"></i> Contact Us</a></li>
                        </ul>
                    </div>
                    <div className="col-lg-3 col-md-6">
                        <h4 className="mb-3">Contact</h4>
                        <p className="small"><i className="ri-map-pin-line me-2"></i>100 City Centre Dr, Mississauga, ON</p>
                        <p className="small"><i className="ri-phone-line me-2"></i>+1 (416)-123-4567</p>
                        <p className="small"><i className="ri-mail-line me-2"></i>cruz.entertainment@gmail.com</p>
                    </div>
                </div>
