        ...
        <div className="row gx-5 align-items-start">
          ...
          <div className="col-lg-8 mb-4 mb-lg-0">
            ...
            <p className="text-light mb-4" style={{ maxWidth: "600px" }}>
              ...
              <strong>{location}</strong> is confirmed. Below is your booking
              summary.
            </p>
            ...
            <div className="bg-dark p-4 rounded shadow-sm">
              ...
              {[
                ...
                hotel?.title && [
                  "Hotel",
                  `${hotel.title} - $${hotel.cost.toFixed(2)}`,
                ],
          ...
          <div className="col-lg-4">
            <div className="bg-dark p-4 rounded shadow-sm text-white border border-secondary">
              ...
              <p className="small text-light">
                Click the button below to generate a PDF invoice with all
                booking details. You can download or print it for your records.
              </p>
