        ...
        <div className="row">
          ...
          <div className="col-lg-6 mb-4">
            <img
              src={vanimg}
              alt="Main Van"
              className="blog-section__main-img img-fluid rounded"
            />
          </div>
          ...
          <div className="col-lg-6">
            <div className="blog-section__post mb-4">
              ...
              <div className="d-flex justify-content-between blog-section__meta small">
                ...
                <span>
                  <i className="ri-time-line me-1"></i>10 Min Read
                </span>
              </div>
            </div>
          ...
          <div className="col-md-4 mb-4">
            <div className="blog-section__card rounded overflow-hidden">
              ...
              <div className="p-3">
                ...
                <div className="d-flex justify-content-between blog-section__meta small">
                  <span>
                    <i className="ri-user-line me-1"></i>Sarah Lee
                  </span>
                  <span>
                    <i className="ri-time-line me-1"></i>8 Min Read
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="col-md-4 mb-4">
            <div className="blog-section__card rounded overflow-hidden">
              ...
              <div className="p-3">
                ...
                <div className="d-flex justify-content-between blog-section__meta small">
                  <span>
                    <i className="ri-user-line me-1"></i>Michael Smith
                  </span>
                  <span>
                    <i className="ri-time-line me-1"></i>6 Min Read
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="col-md-4 mb-4">
            <div className="blog-section__card rounded overflow-hidden">
              ...
              <div className="p-3">
                ...
                <div className="d-flex justify-content-between blog-section__meta small">
                  <span>
                    <i className="ri-user-line me-1"></i>Anna Wright
                  </span>
                  <span>
                    <i className="ri-time-line me-1"></i>9 Min Read
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="col-md-4 mb-4">
            <div className="blog-section__card rounded overflow-hidden">
              ...
              <div className="p-3">
                ...
                <div className="d-flex justify-content-between blog-section__meta small">
                  <span>
                    <i className="ri-user-line me-1"></i>Jason Lee
                  </span>
                  <span>
                    <i className="ri-time-line me-1"></i>7 Min Read
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="col-md-4 mb-4">
            <div className="blog-section__card rounded overflow-hidden">
              ...
              <div className="p-3">
                ...
                <div className="d-flex justify-content-between blog-section__meta small">
                  <span>
                    <i className="ri-user-line me-1"></i>Emma Davis
                  </span>
                  <span>
                    <i className="ri-time-line me-1"></i>5 Min Read
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="col-md-4 mb-4">
            <div className="blog-section__card rounded overflow-hidden">
              ...
              <div className="p-3">
                ...
                <div className="d-flex justify-content-between blog-section__meta small">
                  <span>
                    <i className="ri-user-line me-1"></i>Oliver Brown
                  </span>
                  <span>
                    <i className="ri-time-line me-1"></i>12 Min Read
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="col-md-4 mb-4">
            <div className="blog-section__card rounded overflow-hidden">
              ...
              <div className="p-3">
                ...
                <div className="d-flex justify-content-between blog-section__meta small">
                  <span>
                    <i className="ri-user-line me-1"></i>Lucas Reed
                  </span>
                  <span>
                    <i className="ri-time-line me-1"></i>7 Min Read
                  </span>
          ...
          <div className="col-md-4 mb-4">
            <div className="blog-section__card rounded overflow-hidden">
              ...
              <div className="p-3">
                ...
                <div className="d-flex justify-content-between blog-section__meta small">
                  <span>
                    <i className="ri-user-line me-1"></i>Grace Palmer
                  </span>
                  <span>
                    <i className="ri-time-line me-1"></i>8 Min Read
                  </span>
          ...
          <div className="col-md-4 mb-4">
            <div className="blog-section__card rounded overflow-hidden">
              ...
              <div className="p-3">
                ...
                <div className="d-flex justify-content-between blog-section__meta small">
                  <span>
                    <i className="ri-user-line me-1"></i>Oliver Chase
                  </span>
                  <span>
                    <i className="ri-time-line me-1"></i>11 Min Read
                  </span>
                </div>
              </div>
            </div>
