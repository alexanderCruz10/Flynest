                    ...
                    <div className="hero-overlay text-white">
                        ...
                        <div className="container w-100 travel-box p-4  bg-dark text-white rounded z-0">
                            <div className="row align-items-center justify-content-between w-100 gap-4 gap-xl-0">
                                <div className="col-xl-2 travel-info" style={{ borderRight: "1px solid rgba(248, 250, 252, .08)" }}>
                        ...
                        <div className="row">
                            <div className="col-lg-6">
                                ...
                                <div className="user-icon d-flex gap-3 mt-4">
                                    ...
                                    <p className="about-para">2,500 People Booked Tomorrow Land Event in the Last 24 hours</p>
                                </div>
                            </div>
                    ...
                    <div className="container">
                        ...
                        <div className="row py-5 mt-5">
                            ...
                            <div className="col-lg-6 explore-content text-white">
                                ...
                                <p className='mb-4'>Lorem ipsum dolor sit amet consectetur. Nullam amet at sed dui tellus tempor pretium tincidunt. Id amet sit viverra dolor consectetur elementum. Non at volutpat aliquam ac ac at amet. Ut semper semper sit aliquam penatibus dolor tortor nisl.</p>

                                <span><p className='m-0 mb-2 ps-3'>Lorem ipsum dolor sit amet consectetur. Platea urna hendrerit dui eget velit sollicitudin orci. Non sit lorem dolor placerat faucibus.</p></span>
                                <span><p className='m-0 mb-3 ps-3'>Lorem ipsum dolor sit amet consectetur. Platea urna hendrerit dui eget velit sollicitudin orci.</p></span>
