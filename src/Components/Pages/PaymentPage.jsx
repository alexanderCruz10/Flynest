          ...
          <div className="col-md-4 mt-5 mt-md-0">
            <div className="p-4 rounded bg-section-light text-white border">
              ...
              <div className="bg-dark rounded p-3">
                ...
                <p>
                  VAT Tax <span className="float-end">${tax.toFixed(2)}</span>
                </p>
                <p>
                  Adults <span className="float-end">{adults}</span>
                </p>
                <p>
                  Children <span className="float-end">{children}</span>
                </p>
                <p>
                  Tour Guide{" "}
                  <span className="float-end">${tourGuide.toFixed(2)}</span>
                </p>
                <p>
                  Dinner <span className="float-end">${dinner.toFixed(2)}</span>
                </p>
                {transportTitle && (
                  <p>
                    {transportTitle}{" "}
                ...
                {hotelTitle && (
                  <p>
                    {hotelTitle}{" "}
                    <span className="float-end">${hotelCost.toFixed(2)}</span>
                  </p>
                )}
                <hr />
                <p className="fw-bold">
                  Total{" "}
                  <span className="float-end text-highlight">
                    ${total.toFixed(2)}
                  </span>
                </p>
              </div>
              ...
              <button
                className="btn btn-book w-100 mt-3 text-white btn-custome"
