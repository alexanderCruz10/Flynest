...
import transportData from "../../../src/Data/Transport.json";
...
const TransportDetailPage = () => {
  ...
  const handleBookNow = (vehicle) => {
    const alreadyInCart = cartItems.find((item) => item.id === vehicle.id);
          ...
          <div className="col-lg-3 pb-3">
            <div className="filter-sidebar shadow-sm">
              ...
              <fieldset className="filter-section">
                <legend>
                  <i className="ri-map-pin-line me-2 "></i>Destination
                </legend>
              ...
              <fieldset className="filter-section">
                <legend>
                  <i className="ri-flight-takeoff-line me-2"></i>Tour Type
                </legend>
                <select className="form-select">
              ...
              <fieldset className="filter-section">
                <legend>
                  <i className="ri-calendar-event-line me-2 "></i>Date From
                </legend>
              ...
              <fieldset className="filter-section">
                <legend>
                  <i className="ri-user-smile-line me-2 text-white"></i>Guests
                </legend>
                <input
                  type="number"
              ...
              <fieldset className="filter-section ">
                <legend>
                  <i className="ri-star-smile-line me-2"></i>Traveler Rating
                </legend>
              ...
              <fieldset className="filter-section">
                <legend>
                  <i className="ri-price-tag-3-line me-2"></i>Special Offers
                </legend>
              ...
              <fieldset className="filter-section">
                <legend>
                  <i className="ri-translate-2 me-2"></i>Languages
                </legend>
              ...
              {transportData.map((vehicle) => (
                <div key={vehicle.id} className="col-md-6 col-xl-4 mb-4">
                  <div className="transport-card p-3 shadow-sm h-100 d-flex flex-column">
                    ...
                    <h6 className="fw-bold mb-1 text-white">{vehicle.name}</h6>
